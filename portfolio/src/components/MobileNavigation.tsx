...
function UserIcon() {
  return <svg className="social-icon" style={{ width: "1.125rem", height: "1.125rem" }} aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9.5" /><circle cx="12" cy="8.5" r="2.45" fill="currentColor" stroke="none" /><path d="M6.5 18.1c.95-3.05 2.85-4.6 5.5-4.6s4.55 1.55 5.5 4.6A9.4 9.4 0 0 1 12 20a9.4 9.4 0 0 1-5.5-1.9Z" fill="currentColor" stroke="none" /></svg>;
}
...
export { UserIcon, GitHubIcon, LinkedInIcon };
